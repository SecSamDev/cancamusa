...
kms_keys = [
    ...
    ["Windows 10 Enterprise N", "92NFX-8DJQP-P6BBQ-THF9C-7CG2H"],
    ["Windows 10 Remote Server", "7NBT4-WGBQX-MP4H7-QXFF8-YP3KX"],
    ["Windows 11 Remote Server", "7NBT4-WGBQX-MP4H7-QXFF8-YP3KX"],
    ...
    ["Windows 11 Enterprise multi-session", "CPWHC-NT2C7-VYW78-DHDB2-PG3GK"],
    ...
    ["Windows 11 Enterprise S", "H76BG-QBNM7-73XY9-V6W2T-684BJ"],
    ["Windows 10 Enterprise S N", "X4R4B-NV6WD-PKTVK-F98BH-4C2J8"],
    ["Windows 11 Enterprise S N", "X4R4B-NV6WD-PKTVK-F98BH-4C2J8"],
    ...
    ["Windows 11 Core N", "3KHY7-WNT83-DGQKR-F7HPR-844BM"],
    ["Windows 10 Home Single Language", "7HNRX-D7KGG-3K4RQ-4WPJ4-YTDFH"],
    ["Windows 11 Home Single Language", "7HNRX-D7KGG-3K4RQ-4WPJ4-YTDFH"],
    ["Windows 10 Core Single Language", "4NX46-6DHCG-MR3PH-9FMCX-3RQ3G"],
    ...
    ["Windows 8 Embedded Industry pro", "JVPDN-TBWJW-PD94V-QYKJ2-KWYQM"],
...
def select_license(image_name):
    if "SERVERDATACENTER" in image_name:
        image_name = image_name.replace("SERVERDATACENTERCORE","Datacenter").replace("SERVERDATACENTER","Datacenter")
    elif "SERVERSTANDARD" in image_name:
        image_name = image_name.replace("SERVERSTANDARDCORE","Standard").replace("SERVERSTANDARD","Standard")

    selected_key = ""
    for key in kms_keys:
        if key[0] == image_name:
            return key[1]
        elif image_name.lower() in key[0].lower():
            selected_key = key[1]
    return selected_key